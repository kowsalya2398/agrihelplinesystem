...
cur = conn.cursor()
q1="""select max(id) from student_reg_details"""
cur.execute(q1)
r=cur.fetchone()
if r[0]==None:
    n=0
...
margin: 0;
padding: 0;
background-image:url("images/ac2.jfif");
...
<script>
 function validate()
 {
  var a,b,c,d,e,f,h,i,j,k,l,m,n,o;
  ...
  f=document.getElementById("clg1")
...
print("""<tr><td>ID:</td><td><input type="text" name="studentid" readonly value='%s'></td></tr>"""%(studentid))
print("""<tr><td>Name:</td><td><input type="text" name="name" id="name1"></td></tr>
                               ...
                               <tr><td>QUALIFICATION:</td><td>
                                <select name="qualification" id="qual1">
                                 <option></option>
                                 <option>B.Sc(Agri)</option>
                                 <option>B.E(Agri)</option>
                                 <option>Any Degree</option>
                                </select>
                                <tr><td>COLLEGE:</td><td><input type="text" name="college" id="clg1" placeholder="College"></textarea></td></tr>
                               ...
                               <tr><td>CONFIRM PASSWORD:</td><td><input type="password"  id="psw2" name="pass2" placeholder="Renter_password"></td></tr>
...
if psub!=None:
    ...
    if pphto.filename:
        ...
        q1="""INSERT INTO student_reg_details (student_id,name,dob,gender,qualification,college,address,district,state,email,contactno,createpassword,confirmpassword,photoupload) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"""  %(pstdid,pName,pdob,pgen,pqual,pclg,padd,pdist,pstate,pemail,pcontact,pcreate,pconform,fn)
