...
if len(f)==1:
    ...
    if psub!=None:
        q1="""update student_reg_details set Studentid='%s',Name='%s',DOB='%s',Gender='%s',Qualification='%s',College='%s',Address='%s',District='%s',State='%s',Email='%s',Contactno='%s',Createpassword='%s',Confirmpassword='%s',photoupload='%s' where id='%s'""" %(pstdid,pName,pdob,pgen,pqual,pclg,padd,pdist,pstate,pemail,pcontact,pcreate,pconform,pphto,pid)
        cur.execute(q1)
        conn.commit()
        print("""
        <script>
...
print("""        <h1 align="center">Registration Form</h1>
             <form action="#" method="get">
                ...
                <tr><td>ID:</td><td><input type="text" name="studentid" value='%s'></td></tr>
               ...
               <tr><td>QUALIFICATION:</td><td>
                ...
                <tr><td>COLLEGE:</td><td><textarea rows="3" cols="20" name="college">%s</textarea></td></tr>
...
</html>"""%(r[0],r[1],r[2],r[6],r[7],r[9],r[10],r[11],r[12],r[13],r[14]))
