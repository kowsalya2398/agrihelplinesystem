         ...
         <div id="wrapper">
            <div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
               ...
               <ul class="nav navbar-nav side-nav">
						<li>
							<a href="farmer_profile.py?id=%s" data-toggle="collapse" data-target="#submenu-1" id="font_dash"><i class="fa fa-fw fa-search"></i>Profile<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:100px;"></span></a>
						</li>
						<li>
							<a href="farmer_soil_view.py?id=%s" data-toggle="collapse" data-target="#submenu-2" id="font_dash"><i class="fa fa-fw fa-search"></i>Soil Information<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:100px;"></span></a>
			            </li>
						<li>
							<a href="farmer_crop_view.py?id=%s" data-toggle="collapse" data-target="#submenu-3" id="font_dash"><i class="fa fa-fw fa-star"></i>Crop information<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:138px;"></span></a>                    
						</li>
						<li>
							<a href="farmer_govtschm_view.py?id=%s" data-toggle="collapse" data-target="#submenu-4" id="font_dash"><i class="fa fa-fw fa-star"></i>Governmernt Schemes<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:138px;"></span></a>                    
						</li>
						<li>
							<a href="farmer_query_req.py?id=%s" data-toggle="collapse" data-target="#submenu-5" id="font_dash"><i class="fa fa-fw fa-star"></i>Queries<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:138px;"></span></a>                    
						</li>
					</ul>
               </div> 
         </div>
...
cur=conn.cursor()
s1="""select * from farmer_reg_details where id=%s""" % (id)
cur.execute(s1)
i=cur.fetchone()
print("""
      <table>
      <tr><td colspan="2" ><img src="%s" height="75" width="75" style="border-radius:50px;"></td></tr>
      <tr><th>Farmerid</th><td>%s</td></tr>
      ...
      <tr><th>Confirmpassword</th><td>%s</td></tr>
      <td><a href="adm_farmer_edit.py?id=%s">Edit</a></td>
      """ %("images/"+i[13],i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11],i[12],i[0]))
print("</table>")
conn.close()
print("""
