...
body 
	  {
		 ...
		 background: url(images/ac3.jfif) no-repeat center center fixed ; 
...
<body>
	<div class="container-fluid" class="jumbotron text-center">
		<div class="row well">
		     <div class="col-sm-1"><img class="img-circle" height="50" width="100%" src="images/agrilogo.jpg"></div>
			 <div class="col-sm-6"><h3 width="100%" ><b class="text-default">STUDENT</b></h3></div>
...
if sub != None:
    ...
    q = """select id from student_reg_details where Email='%s' and Confirmpassword='%s'""" % (uname, pwd)
    ...
    if res != None:
        print("""<script>location.href="student_page.py?id=%s";</script>""" %(res[0]))
    else:
