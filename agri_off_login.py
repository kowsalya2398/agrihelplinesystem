...
body 
	  {
		 ...
		 background: url(images/ca.jpg) no-repeat center center fixed ; 
...
<body>
	<div class="container-fluid" class="jumbotron text-center">
		<div class="row well">
			 ...
			 <div class="col-sm-7"><h2 width="100%" ><b class="text-default">AGRI OFFICER LOGIN</b></h2></div>
...
if sub != None:
    ...
    q = """select id from agrireg_details where email='%s' and confirmpassword='%s'""" % (uname,pwd)
    ...
    if res!=None:
        print("""<script>location.href="agriofficer_page.py?id='%s'";</script>""" %(res[0]))
    else:
