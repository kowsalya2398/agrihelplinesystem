	...
	<div class="w3-container w3-teal">
		<nav class="navbar navbar-inverse" style="background-color:transparent;border:none;">
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-2">
						<img src="images/agrilogo.jpg" height="70px" width="70px" class="img-responsive img-circle" style="margin-top:8px;">
					</div>
					<div class="col-sm-6">
						<p id="font_head">AGRI HELPLINE</p>
					</div>
					<div class="col-sm-4">
...
if len(f)==1:
    ...
    if psub!=None:
        q1="""update agrireg_details set agri_offid='%s',name='%s',dob='%s',gender='%s',qualification='%s',workexperience='%s',worklocation='%s',address='%s',district='%s',state='%s',email='%s',contactno='%s',createpassword='%s',confirmpassword='%s',photoupload='%s' where id='%s'""" %(pagid,pName,pdob,pgen,pqual,pworkex,pworkloc,padd,pdist,pstate,pemail,pcontact,pcreate,pconform,pphto,pid)
        cur.execute(q1)
        conn.commit()
        print("""
        <script>
        ...
        """)
q="""select * from agrireg_details where id=%s""" %(pid)
cur.execute(q)
r=cur.fetchone()
             ...
             <form action="#" method="get">
                <table align="center" cellspacing="5" cellpadding="7" >
                  <input type="hidden" name="id" value='%s'>
                   <tr><td>ID:</td><td><input type="text" name="agrioffid" value='%s'></td></tr>
                   ...
                   <tr><td>WORK EXPERIENCE:</td><td><input type="text" name="experience" value='%s'></td></tr>
                   <tr><td>WORK LOCATION:</td><td><input type="text"  name="location" value='%s'></td></tr>
...
</html>"""%(r[0],r[1],r[2],r[6],r[7],r[8],r[10],r[11],r[12],r[13],r[14],r[15]))
