...
body 
	  {
		 ...
		 background: url(images/j9.jpg) no-repeat center center fixed ; 
...
<body>
	<div class="container-fluid" class="jumbotron text-center">
		<div class="row well">
		     <div class="col-sm-1"><img class="img-circle" height="50" width="100%"  height="75px" width="75px" src="images/agrilogo.jpg"></div>
			 <div class="col-sm-6"><h3 width="100%" ><b class="text-default">GENERAL PUBLIC</b></h3></div>
			 <div class="col-sm-5"><h3 width="100%"><b class="pull-right glyphicon glyphicon-home">&nbsp;<a href="agri_homepage.py" target="_blank">HOME</b></h3></a></div>
		</div>
   </div> 
<div class="loginbox">
...
if sub != None:
    ...
    q = """select id from genuser_reg_details where Email='%s' and Confirmpassword='%s'""" % (uname, pwd)
    ...
    if res != None:
        print("""<script>location.href="genuser_page.py?id='%s'";</script>"""%(res[0]))
    else:
