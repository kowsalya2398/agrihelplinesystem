				...
				<div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
					...
					<ul class="nav navbar-nav side-nav">
	                    <li>
                       	...
                       	<li>
							<a href="genuser_soil_view.py?id=%s" data-toggle="collapse" data-target="#submenu-2" id="font_dash"><i class="fa fa-fw fa-star"></i>Soil Information<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:138px;"></span></a>                    
						</li>
						<li>
						...
						<li>
							<a href="genuser_govtschm_view.py?id=%s" data-toggle="collapse" data-target="#submenu-3" id="font_dash"><i class="fa fa-fw fa-star"></i>Government Schemes<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:138px;"></span></a>                    
						</li>
						<li>
							<a href="genuser_query_req.py?id=%s" data-toggle="collapse" data-target="#submenu-4" id="font_dash"><i class="fa fa-fw fa-star"></i>Queries<i class="fa fa-fw fa-angle-down pull-right"></i><span style="padding-left:138px;"></span></a>                    
						</li>
					</ul>
				</div>	
			</div>
...
cur=conn.cursor()
s1="""select * from genuser_reg_details where id=%s""" % (id)
cur.execute(s1)
i=cur.fetchone()
...
print("""
      ...
      <tr><th>Genuserid</th><td>%s</td></tr>
      <tr><th>Name</th><td>%s</td></tr>
      <tr><th>DOB</th><td>%s</td></tr>
      <tr><th>Gender</th><td>%s</td></tr>
      <tr><th>Companyname</th><td>%s</td></tr>
      ...
      <td><a href="adm_genuser_edit.py?id=%s">Edit</a></td>
