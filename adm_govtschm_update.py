...
<head>
 ...
 <link rel="icon" type="images/ico" href="images/icon.jpg">
  ...
  <link rel="stylesheet" type="text/css" href="bootstrap/bootstrap/styleTV.css">
                ...
                <div class="container-fluid">
                    <div class="row" id="main">
                        <div class="col-sm-12 col-md-12 well">
                                <form action="adm_govtschm_update.py" method="post" enctype="multipart/form-data">

                                    Select govt schm image:
                                    <input type="file" name="filename"><br><br>
                                    Crop Description:<input type="text" name="description"><br><br>
...
if psub != None:
    ...
    if fileitem.filename:
        ...
        sql = """insert into govt_img(filename,filedescription) values('%s','%s')""" % (fn, description)
        cur.execute(sql)
        conn.commit()
