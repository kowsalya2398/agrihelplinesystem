...
q2="""SELECT * FROM student_reg_details"""
try:
    cur.execute(q2)
    res=cur.fetchall()
except:
...
for i in res:
    print("""
            <tr>
                ...
                <td><a href="adm_student_delete.py?id=%s">Delete</a></td>         
           </tr>
           """ %(i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11],i[12],i[13],i[14],i[0],i[0]))
print("</table>")
