	...
	<div class="w3-container w3-teal">
		<nav class="navbar navbar-inverse" style="background-color:transparent;border:none;">
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-2">
						<img src="images/agri_logo.png" class="img-responsive img-circle"  height="100px" width="100px" style="margin-top:8px;">
					</div>
					<div class="col-sm-6">
...
if len(f)==1:
    ...
    if psub!=None:
        q1="""update genuser_reg_details set Genuserid='%s',Name='%s',DOB='%s',Gender='%s',Companyname='%s',Address='%s',District='%s',State='%s',Email='%s',Contactno='%s',Createpassword='%s',Confirmpassword='%s',photoupload='%s' where id='%s'""" %(pgenid,pName,pdob,pgen,pcmpy,padd,pdist,pstate,pemail,pcontact,pcreate,pconform,pphto,pid)
        cur.execute(q1)
        conn.commit()
        print("""
        <script>
...
print("""        <h1 align="center">Registration Form</h1>
             <form action="#" method="get">
                ...
                <tr><td>ID:</td><td><input type="text" name="genuserid" value='%s'></td></tr>
               ...
               <tr><td>COMPANY NAME:</td><td><input type="text" name="company" value='%s'></td></tr>
...
</html>"""%(r[0],r[1],r[2],r[5],r[6],r[8],r[9],r[10],r[11],r[12],r[13]))
